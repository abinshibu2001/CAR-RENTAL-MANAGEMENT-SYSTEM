<?php
 ...
 $id=$_GET["id"];
 $sql="SELECT booking.*, vehicle.car_title,vehicle.image1,DATEDIFF(re_date,rs_date)  as days, (DATEDIFF(re_date,rs_date))* price as amount,users.name from vehicle,booking,users where vehicle.vehicle_id=booking.vehicle_id and users.userid=booking.userid and book_id=$id";
  //echo $sql;
