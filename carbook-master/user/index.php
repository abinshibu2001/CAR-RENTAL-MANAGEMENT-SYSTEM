                ...
                <div class="car-wrap rounded ftco-animate">             
                  <div class="img rounded d-flex align-items-end" style="background-image: url(../uploads/<?php echo $rows['image']  ?>);">
                   ...
                   <div class="text">                 
                     ...
                     <p class="d-flex mb-0 d-block"><a href="car.php" class="btn btn-primary py-2 mr-1">VIEW</a></p>
                   </div>
                </div>
              </div>
              <?php                
                ...
                <div class="car-wrap rounded ftco-animate">             
                  <div class="img rounded d-flex align-items-end" style="background-image: url(../uploads/<?php echo $rows['image1']  ?>);">
                   ...
                   <div class="text">                 
                     ...
                     <p class="d-flex mb-0 d-block"><a href="car-single.php" class="btn btn-primary py-2 mr-1">Book now</a> <a href="car-single.php?vehicle_id=<?php echo $rows['vehicle_id'];?>" class="btn btn-secondary py-2 ml-1">Details</a></p>
                   </div>
                </div>
              </div>
              <?php                
